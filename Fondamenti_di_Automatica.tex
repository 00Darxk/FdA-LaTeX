...
\begin{center}
    \begin{tikzpicture}[scale=2]
        ...
        \draw[->,ultra thick](1.8,0)--(1.8,1);
        \draw[->,ultra thick](2.2,0)--(2.2,1);
        \draw[->,ultra thick](2.6,0)--(2.6,1);
...
Bisogna ottenere le compomnenti della serie di Fuorier rispetto ad un sistema di coordinate ortogonali. La trasformata di Fuorier è un elemento basilare per analizzare 
...
Analogamente ad uno spazio vettoriale, l'integrale di Fuorier di una certa funzione agisce come un'operazione di proiezione. Per cui per trovare i coefficienti $c_k$, corrispondenti 
alle componenti della rastrelliera $\delta_R(t)$, si proietta la funzione tramite l'integrale di Fuorier:
\begin{equation}
