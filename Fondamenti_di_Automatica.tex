...
\begin{center}
    \begin{tikzpicture}[scale=2]
        \draw[->,very thick](-0.5,0)--(1,0)node[above]{$\Re$};
        \draw[->,very thick](0,-1)--(0,1)node[right]{$\Im$};

        \draw[->,snake it, ultra thick](0,-1.5)--(0,-0.75);
        \draw[-,snake it, ultra thick](0,-0.75)--(0,0);
        \draw[->,snake it, ultra thick](0,0)--(0,0.75);
        \draw[-,snake it, ultra thick](0,0.75)--(0,1.5);
        
        \draw[->, snake it, ultra thick](0,1.5)arc(90:45:1.5cm);
        \draw[-, snake it, ultra thick](1.5,0)arc(0:45:1.5cm);       
        \draw[->, snake it, ultra thick](1.5,0)arc(0:-45:1.5cm);
        \draw[-, snake it, ultra thick](0,-1.5)arc(-90:-45:1.5cm);
...
Se la fase di una funzione di trasferimento non scende al di sotto dei $-180^{\circ}$ allora non potrà mai girare intorno al punto $-1$, poiché il modulo tende semper 
a $0$ per ogni funzione di trasferimento stabile. 
