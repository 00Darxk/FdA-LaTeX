...
%   Grafico Shannon \omega_c;
%   Grafico Filtro Passa-Basso s->t;
...
\begin{center}
    \begin{tikzpicture}[scale=2]
        ...
        \node[block](ad)at(1,-0.5){$A/D$};

        \draw[->,ultra thick, densely dotted](-0.25,0.5)node[above right]{$n$}--(dac.180);
        \draw[<-,ultra thick, densely dotted](-0.25,-0.5)--(ad.180)node[below left]{$n$};
        \draw[->,thick, red](-0.25,-0.3)node[above right]{$SoC$}--(0.5,-0.3);        
        \draw[<-,thick, red](-0.25,-0.7)--(0.5,-0.7)node[below left]{$EoC$};

        \node[block](p)at(2.5,0.5){$P$};
        \draw[->,ultra thick](dac.0)--(p.180);
        \draw[->,ultra thick](p.0)--(3.5,0.5);
        \filldraw[black](3.25,0.5)circle(1pt);

        \node[nblock](aa)at(2.5,-0.5){};
        \draw[->, thick](2.2,-0.6)--(2.8,-0.6);
        \draw[->, thick](2.5,-0.7)--(2.5,-0.3);
        \draw[-,thick](2.3,-0.4)--(2.7,-0.4);
        \draw[-,thick](2.3,-0.4)--(2.3,-0.6);
        \draw[-,thick](2.7,-0.4)--(2.7,-0.6);

        \draw[-,ultra thick](3.25,-0.5)--(3.25,0.5);
        \draw[->,ultra thick](3.25,-0.5)--(aa.0);
        \draw[->,ultra thick](aa.180)--(ad.0);
        \node[sum](ca)at(1.75,-0.5){};
